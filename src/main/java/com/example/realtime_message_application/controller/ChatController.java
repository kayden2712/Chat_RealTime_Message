...
public class ChatController {
    ...
    public void editMessage(@Payload EditMessage editMessage) {
        ...
        // notificationService.notifyParticipants(editMessage.conversationId(), updatedMessage);
    }
    ...
    public void changeParticipantRole(@Payload UpdateConvRole roleUpdate) {
        ...
        ConversationResponse updatedConversation = conversationService.getConversationById(roleUpdate.conversationId());
        chatEventPublisher.broadcastToConversation(
